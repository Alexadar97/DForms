...
declare var $;
@Component({
  selector: 'app-nmcs-approval',
  templateUrl: './nmcs-approval.component.html',
  styleUrls: ['./nmcs-approval.component.css']
})
export class NmcsApprovalComponent implements OnInit {
  ...
  //   var usertype = this.patchValue.approvertype
